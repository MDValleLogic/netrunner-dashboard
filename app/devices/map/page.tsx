  ...
  function initMap() {
    ...
    mapInstanceRef.current = new (window as any).google.maps.Map(mapRef.current, {
      ...
      styles: [
        ...
        { elementType: "labels.text.fill", stylers: [{ color: "#c9d1e0" }] },
        { elementType: "labels.text.stroke", stylers: [{ color: "#1e2433" }] },
        { featureType: "road", elementType: "geometry", stylers: [{ color: "#3a4560" }] },
        { featureType: "road", elementType: "geometry.stroke", stylers: [{ color: "#2a3450" }] },
        { featureType: "road", elementType: "labels.text.fill", stylers: [{ color: "#a0aec0" }] },
        { featureType: "road.highway", elementType: "geometry", stylers: [{ color: "#4a5880" }] },
        { featureType: "road.highway", elementType: "labels.text.fill", stylers: [{ color: "#cbd5e0" }] },
        ...
        { featureType: "landscape", elementType: "geometry", stylers: [{ color: "#1a2235" }] },
        ...
        { featureType: "administrative.neighborhood", elementType: "labels.text.fill", stylers: [{ color: "#a0aec0" }] },
      ],
      zoomControl: true,
  ...
  useEffect(() => {
    ...
    sites.forEach(site => {
      ...
      const marker = new maps.Marker({
        ...
        label: count > 1 ? { text: String(count), color: "#ffffff", fontSize: "13px", fontWeight: "bold", fontFamily: "monospace" } : { text: "●", color: "#ffffff", fontSize: "10px" },
      });
