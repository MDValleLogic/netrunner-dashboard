    ...
    <>
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .mfa-sub { font-size: 14px; color: #64748b; line-height: 1.65; margin-bottom: 28px; }
        ...
        .mfa-btn-pri { width: 100%; background: #0ea5e9; border: none; border-radius: 8px; padding: 13px; font-family: 'Space Mono', monospace; font-size: 12px; font-weight: 700; letter-spacing: 0.08em; color: #fff; cursor: pointer; transition: all 0.2s; }
              ...
              <>
                ...
                {step === "scan" && (
                  <div className="mfa-body">
                    ...
                    <div className="mfa-sub">Scan the QR code with Google Authenticator, Authy, or any TOTP app. Then click Continue.</div>
                    ...
                    <button className="mfa-btn-sec" onClick={() => setStep("verify")}>
