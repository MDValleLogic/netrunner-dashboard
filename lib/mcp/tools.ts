...
export async function dispatchToolExtended(
  ...
  switch (toolName) {
    ...
    case "get_global_runner_config":  return getGlobalRunnerConfig(tenantId, args.runner_type as string | undefined);
    case "set_global_runner_config":  return setGlobalRunnerConfig(tenantId, args.runner_type as string, args.config as object);
    case "get_device_runner_config":  return getDeviceRunnerConfig(args.device_id as string, tenantId, args.runner_type as string | undefined);
    case "set_device_runner_config":  return setDeviceRunnerConfig(args.device_id as string, tenantId, args.runner_type as string, args.config as object);
    case "delete_device_runner_config": return deleteDeviceRunnerConfig(args.device_id as string, tenantId, args.runner_type as string);
